...
def lambda_handler(event, context):
    ...
    if image_data_base64:
        ...
        s3_key = "incident_images/oil_spill_images/oil_spill_image_" + str(int(time.time())) + ".jpg"
    ...
    subject = "Oil Spill Incident Report"
    message = f"An incident of Oil Spill has been reported for {place}. Please find the details below.\n"
    message += f"Name: {name}\n"
    ...
    sns_topic_arn = "arn:aws:sns:us-east-1:196551330648:OilSpillCfAlertTopic"
