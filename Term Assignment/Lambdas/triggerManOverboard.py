...
def lambda_handler(event, context):
    ...
    if image_data_base64:
        ...
        s3_key = "incident_images/man_overboard_images/man_overboard_image_" + str(int(time.time())) + ".jpg"
    ...
    subject = "Man Overboard Incident Report"
    message = f"An incident of Man Overboard has been reported for {place}. Please find the details below.\n"
    message += f"Name: {name}\n"
    ...
    sns_topic_arn = "arn:aws:sns:us-east-1:196551330648:ManOverboardAlertCfTopic"
